...
public final class SwiftDataManager {
    ...
    public init(supportedEntities: [any PersistentModel.Type], isStoredInMemoryOnly: Bool) {
    ...
    public func save(_ context: ModelContext, completion: ((Bool) -> Void)? = nil) {
        var result = true
        defer {
    ...
    @MainActor public func getMatchingEntities<T: PersistentModel>(
        _ entity: T.Type,
    ...
    ///   - predicate: Predicate for filtering the data
    ///   - context: Model context instance
    public func deleteEntities<T: PersistentModel>(_ entity: T.Type, with predicate: Predicate<T>? = nil, in context: ModelContext) {
        do {
